...
class _TestInfo(object):
    ...
    def __init__(self, test_result, test_method, outcome=SUCCESS, err=None, subTest=None):
        ...
        self.test_description = test_description.split()[0] if len(test_description.split())<3 else test_description.split()[2]
...
class _HtmlTestResult(_TextTestResult):
    ...
    def report_testcase(self, testCase, test_cases_list):
        ...
        screenshot = testCase.screenshot.split(os.sep)[-1] if testCase.screenshot is not None else ''
